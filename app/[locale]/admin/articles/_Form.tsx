...
import { addArticles, updateArticles } from '@/actions/articles'
...
const Form = ({ id, data }: { id?: string, data?: Articles }) => {
    const schema = id ? UpdateArticlesSchema : AddArticlesSchema;
    ...
    const onSubmit = async (data: z.infer<typeof schema>) => {
        ...
        const result = id ? await updateArticles(formData, id) : await addArticles(formData);
