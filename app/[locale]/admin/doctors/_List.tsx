...
export default function List({ total }: { total: number }) {
    ...
    const fetchData = async () => {
        const response = await axios.get(`/api/doctors?page=${page + 1}&pageSize=${pageSize}`)
    ...
    const tableCellHeader = [
        "", "image", "nameEn", "nameAr", "expertiseEn", "expertiseAr", "createdAt", "actions"
    ]
                                    ...
                                    {data.map((row: any, index: number) => {
                                        return (
                                            <TableRow hover role="checkbox" tabIndex={-1} key={index}>
                                                ...
                                                <FixedTableCell>
                                                    <Image
                                                        src={row.imagePath ?? "/staticImages/doc-profile.jpg"}
                                                        alt={row.name}
                                                        width={50}
                                                        height={50}
                                                        objectFit="cover"
                                                ...
                                                <FixedTableCell align={'left'}>
                                                    <Stack direction={"row"} spacing={1} >
                                                        ...
                                                        <DeleteItem id={row.id} deleteFun={deleteDoctor}>
