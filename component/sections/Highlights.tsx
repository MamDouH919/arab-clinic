...
const Root = styled(Box)(({ theme }) => ({
    ...
    [`& .${classes.backCircle}`]: {
        ...
        borderTop: `${size / 2}px solid ${theme.palette.secondary.main}`,
        borderLeft: `${size / 2}px solid ${theme.palette.secondary.main}`,
        borderBottom: `${size / 2}px solid ${theme.palette.secondary.main}`,
